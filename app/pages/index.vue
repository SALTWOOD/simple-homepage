...
import { techBadges, friends } from '~/composables/useSiteData'
</script>
...
.section-title {
  ...
  border-bottom: 2px solid color-mix(in srgb, var(--color-amber-400) 25%, transparent);
}
